    ...
    <jsp:include page="Head.jsp"></jsp:include>
        ...
        <script>
            function validate() {
                ...
                var imagesHover = document.getElementById("imageHover").value;
                                    ...
                                    <div class="x_panel">
                                        ...
                                        <f:form class="form-horizontal form-label-left" action="InsertProduct.htm" commandName="newProduct" onsubmit="return validate()" enctype="multipart/form-data" method="POST">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div id="error-imageHover" style="color:red; font-size: 14px;"></div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10 col-sm-10 col-xs-12">
                                                    <f:select id="catalogId" class="form-control col-md-7 col-xs-12"  path="providerId" >
