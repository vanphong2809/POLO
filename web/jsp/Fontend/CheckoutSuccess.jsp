    ...
    <head>
        ...
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
            <meta name="viewport" content="width=device-width, initial-scale=1">
                ...
                <title>Polo - Cảm ơn</title>


                <link rel="shortcut icon" href="/POLO/jsp/Fontend/images/favicon.ico" type="image/x-icon" />
                ...
                <link href="/POLO/jsp/Fontend/css/thankyou.css" rel="stylesheet" type="text/css" />
                ...
                <body class="body--custom-background-color ">
                                                                ...
                                                                <li class="product product-has-image clearfix">
                                                                    <div class="product-thumbnail pull-left">
                                                                        <div class="product-thumbnail__wrapper">
                                                                            ...
                                                                            <img src="/POLO/jsp/Fontend/images/${cart.product.images}" alt="${cart.product.productName}" class="product-thumbnail__image" />
                    ...
                    <script src="/POLO/jsp/Fontend/js/checkout.js" type="text/javascript"></script>
                    ...
                    <script src="/POLO/jsp/Fontend/js/thankyou.js" type="text/javascript"></script>
